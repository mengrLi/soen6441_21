...
public class Map extends Observable {  //
	...
	public String Inspect(int mouseOverIndex) {
		...
		if(country[i].deleted == false) {

			str = 
					"Country = " + country[i].name
					+"\n------------\nContinent = ";
			if(country[i].continent != null) str +=  country[i].continent.name; 
			str += "\nOwned By = ";
			if(country[i].player != null) {
				str += country[i].player.name;
				
			}
			str += "\nResources = " + country[i].resource.toString();
